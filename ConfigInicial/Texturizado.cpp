...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Texturizado Alberto Hernandez", nullptr, nullptr);
	...
	GLfloat vertices[] =
	{
		...
		0.5f,  0.5f, -1.0f,    1.0f, 1.0f,1.0f,    1.0f, 0.5f,
	...
	//Funcion para que la coordenada 0,0 se coloque en la esquina inferior izquierda
